  ...
  >
    ...
    >
      <div class="d-flex align-items-center flex-wrap mr-1">
        ...
        <ul
            class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 list-unstyled"
        >
          <li class="breadcrumb-item ">
            <router-link :to="'/'" class="subheader-breadcrumbs-home">
              <i class="flaticon2-shelter text-muted icon-1x" v-if="true"></i>
            </router-link>
          </li>
