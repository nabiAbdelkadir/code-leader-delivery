<template>
  <!-- begin:: Aside -->
  <div class="brand d-flex flex-column-auto " id="kt_brand" ref="kt_brand">
    <div class="brand-logo">
      <router-link to="/">
        <p class="text-white font-weight-bold text-uppercase font-size-lg mb-0" style="font-size: 1.4rem">
          Code Leader
        </p>
        <img :src="siteLogo()" alt="Logo" v-if="false"/>
      </router-link>
    </div>
