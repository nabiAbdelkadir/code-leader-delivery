<template>
  <ul class="menu-nav">
    ...
    <li v-for="item in menu" :key="item.heading"
        class="menu-section">
      <h4 class="menu-text"> {{ item.heading }}</h4>
      <i class="menu-icon flaticon-more-v2"></i>
    </li>

    <li
        v-for="page in menu[0].pages" :key="page.title"
        aria-haspopup="true"
        data-menu-toggle="hover"
    ...
    >
      <a href="#" class="menu-link menu-toggle">
        <i :class="page.fontIcon"></i>
        <span class="menu-text ">{{ page.title }}</span>
        <i class="menu-arrow"></i>
      </a>


      <div v-for="sub in page.sub" :key="sub.heading"
           class="menu-submenu">
          ...
          >
            ...
            >
              <a :href="href" class="menu-link" @click="navigate">
                ...
                <span class="menu-text">{{ sub.heading }}</span>
              </a>
            </li>
          </router-link>
        </ul>
...
<script>
import MainMenuConfig from "@/core/config/mainMenu.ts";
            ...
            pages: [
              {
                title: "Vue Bootstrap",
                route: "/vue-bootstrap",
                fontIcon: "menu-icon flaticon2-digital-marketing",
                sub: [
                  {
                    heading: "Alert",
                    route: "/vue-bootstrap/alert",
                  },
                  {
                    heading: "badge",
                    route: "/vue-bootstrap/badge",
                  },
                ],
              },
            ]
